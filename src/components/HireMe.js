      ...
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24 ">
        ...
        <Link
          ...
          className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
           bg-dark text-light shadow-md border border-solid border-dark w-20 h-20 font-semibold rounded-full
            hover:bg-light hover:text-dark hover:border-dark dark:bg-light dark:text-dark
