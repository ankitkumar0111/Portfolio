...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    >
      ...
      rounded-br-3xl dark:bg-light xs:-righ-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]" />
      <Link
        href={link}
        target="_blank"
...
const projects = () => {
  return (
    <>
      <Head>
        <title>CodeAnkit | Projects Page</title>
        <meta name="description" content="any description" />
      </Head>
      <TransitionEffect/>
      <main className="w-full mb-16 flex flex-col items-center justify-content dark:text-light">
